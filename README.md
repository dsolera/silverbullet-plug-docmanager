...
Then, copy the resulting `.plug.js` file into your space (path does not matter) or use SilverBullet's integrated Library Manager (`Library: Install` command) to install it by passing the `PLUG.md` URL.
